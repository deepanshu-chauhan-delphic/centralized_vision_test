...
async function getCvPartnerPricing() {
    try {
        const request = await fetch('https://dev.ehostingguru.com/centralised-vision/data/cv-partner-pricing.json');
        return request.json();
    } catch(e) {
        console.log(e)
    }
...
async function getCameraPricing() {
    try {
        const request = await fetch('https://dev.ehostingguru.com/centralised-vision/data/camera-pricing.json');
        return request.json();
    } catch(e) {
        console.log(e)
    }
...
async function getCameraPricingForCvPartner() {
    try {
        const request = await fetch('https://dev.ehostingguru.com/centralised-vision/data/cv-camera-pricing.json');
        return request.json();
    } catch(e) {
        console.log(e)
    }
